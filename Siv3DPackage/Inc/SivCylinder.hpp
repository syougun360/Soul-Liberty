...
#pragma warning(default:4201)
		...
		explicit Cylinder(double _r, double _h, const Quaternion& _rotation = Quaternion::Identity())
			: center{ 0, 0, 0 }
			, r{ _r }
			, h{ _h }
			, rotation{ _rotation }
		...
		Cylinder(double x, double y, double z, double _r, double _h, const Quaternion& _rotation = Quaternion::Identity())
			: center{ x, y, z }
			, r{ _r }
			, h{ _h }
			, rotation{ _rotation }
